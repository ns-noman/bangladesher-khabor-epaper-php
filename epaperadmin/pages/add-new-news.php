...
$(document).ready(function(){
 ...
 $(function() {
        ...
        var customNewsblock = '<div class="cnewsblock ui_enable" style>';
   ...
   dd = $("#create_news_block").offset().top;
    
   position_from_top = dd - 100;
    
//        position_from_top = parseInt(scrollTop);
    if(position_from_top>154)
      position_from_top = position_from_top-154;   
//        
//    position_from_left = 100;
    
              
                   customNewsblock = customNewsblock.replace('style', 'style="top:'+position_from_top+'px; position:absolute"; ');

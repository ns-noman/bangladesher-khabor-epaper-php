...
<div class="page-enty">
 ...
 <form action="" name="get_page_form" id="get_page_form" method="post" enctype="multipart/form-data">
  <ul class="form-el-container">
   ...
   <li><div class="form-element"><label for="">Select Page:</label><select id="page_for_news" name="page_for_news"><option>--Select--</option></select></div></li>
   </ul>
 </form>
 </div><!--#get_page_form-->
...
$(document).ready(function(){
 ...
 $(function() {
  var customNewsblock = '<div class="cnewsblock ui_enable">';
	...
	customNewsblock +='<li><a href="javascript:void(0)" onClick="setNews(this)" class="nsave">Add</a></li>';

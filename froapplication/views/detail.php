...
<title><?php echo isset($title) ? $title : $siteinfo["HomePageTitle"]; ?></title>
     ...
     <meta property="og:image"                content="<?php echo isset($image) ? str_replace("/epaperadmin","",$image) : $this->config->item('assets_url').$siteinfo["Logo"]; ?>"/>
...
<div style=" text-align: center;  clear:both;">
    ...
    <p align="center" class="print">
       <img src="https://www.bangladesherkhabor.net/assets/images/Logo2.png" width="150"/>
    </p>
    <img src="https://www.bangladesherkhabor.net/assets/images/bangladesher-khobor-logo.jpg" width="350"/>
    <br>
    <hr>
    <br>
  ...
  <?php if(isset($_GET['ref'] ) && $_GET['ref']=='f') { 
   ?>
	
	<img src="<?php echo str_replace("/epaperadmin","",$showimage1);?>">
 <br/>
   
   <?php if(isset($showimage2)) { 
   ?>
    <img src="<?php echo str_replace("/epaperadmin","",$showimage2);?>">
